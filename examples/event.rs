...
use bevy_mod_picking::{prelude::EventListenerPlugin, DefaultPickingPlugins};
use bevy_transform_gizmo::{GizmoUpdate, TransformGizmoPlugin};
...
fn main() {
    App::new()
        ...
        .add_systems(Update, entity_change)
        .run();
}
